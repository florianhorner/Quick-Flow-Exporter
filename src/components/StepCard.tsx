...
export default function StepCard({
  ...
  return (
    <div className="border rounded-lg bg-white shadow-sm" role="region" aria-label={label}>
      <div
        className="flex items-center justify-between px-3 py-2 bg-gray-50 rounded-t-lg cursor-pointer"
        role="button"
        tabIndex={0}
        aria-expanded={open}
